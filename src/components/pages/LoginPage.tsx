...
function LoginPage({ forAdmin }: Props) {
  ...
  const loginUser = (user: User) => dispatch(userActions.loginUser(user));
  const loginORCIDUser = (user: any) =>
    dispatch(userActions.loginORCIDUser(user));
  const loginAdmin = (admin: User) => dispatch(userActions.loginAdmin(admin));
      ...
      <section className="login-section">
        ...
        <form className="login-wrapper" onSubmit={handleSubmit}>
          ...
          <div className="login-name">
            <h1 className="login-name-title">
              PubWeave {forAdmin ? "Admin" : ""} Login
            </h1>
          </div>
          ...
          {!forAdmin && (
            <>
              ...
              <div onClick={handleRegister} className="login-signup">
