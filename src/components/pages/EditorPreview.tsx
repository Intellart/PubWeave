...
function ReactEditor() {
  ...
  const updateArticle = (articleId: number, payload: any) =>
  ...
  const removeTag = (articleTagId: number) =>
    dispatch(articleActions.removeTag(id, articleTagId));
  ...
  const checks = [
    ...
    },
    {
      name: "Title",
      check: () =>
        size(get(article, "title")) > 0 &&
        get(article, "title") !== "New article",
      message: "Add a title",
    },
    {
      name: "Image",
