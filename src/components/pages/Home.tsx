            ...
            <div className="hero-section-left">
              ...
              <div className="hero-section-left-buttons">
                ...
                <button
                  onClick={() => {
                    document
                      .getElementsByClassName("team-section")[0]
                      .scrollIntoView({
                        behavior: "smooth",
                      });
                  }}
          ...
          <div className="about-paragraph-img">
            <div className="about-paragraph">
              ...
              <p>
                ...
                Aenean commodo ligula eget dolor. Aenean massa. <br /> Cum
        ...
        <section className="team-section">
          <div className="team-punchline-cta-buttons">
            ...
            <div className="team-punchline">
              <h1>
                Perfect Solution <br /> to Monetize <br /> Scientific Work
              </h1>
              <h4>Pricing plans that fit like a glove.</h4>
              <div className="team-cta-buttons">
                <Link className="submit-work" to="/blogs">
                  Submit Work
                </Link>
                <Link className="more-info" to="/blogs">
                  More Info
                </Link>
              </div>
              ...
              <div className="stars-text">
                ...
                <h4>
                  <strong>5,600 scientists</strong> trust PubWeave <br /> and
                  they rate it as <strong>5-stars.</strong>
                </h4>
              </div>
            </div>
          </div>
