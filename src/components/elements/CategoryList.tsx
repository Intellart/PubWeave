  ...
  return (
    <motion.div
      className={classNames("category-list-item", {
        "category-list-item-active": props.isActive,
      })}
      layoutId={props.isActive ? "category-list-item-active" : undefined}
      onClick={() => props.onClick(props.name)}
    >
      <div className="category-list-item-block-left" />
      <div className="category-list-item-inner-overlay">
        <div
          className={classNames("category-list-item-inner", {
            "category-list-item-empty": !props.articleCount,
          })}
        >
          <p className="category-list-item-name">{props.name}</p>
          <p className="category-list-item-count">
            {props.articleCount || 0} articles
          </p>
        </div>
      </div>
...
export function CategoryList(props: CategoryListProps) {
  ...
  return (
    <div
      className={classNames("category-list-wrapper", {
