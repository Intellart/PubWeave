...
function TutorialModal(props: Props) {
  ...
  const steps = [
    ...
    },
    {
      ...
      description:
        "Select text to edit it. You can change the font, mark it as a heading, or add a link.",
      image: steps3,
    },
    {
      label: "Add images, videos, tables, equations, and more",
      description:
        "Click the plus button to add a block. You can add images, videos, tables, equations, and more.",
      image: steps4,
    },
  ];
