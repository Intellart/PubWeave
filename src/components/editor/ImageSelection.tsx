...
import { isEmpty, map, indexOf, filter, includes, size } from "lodash";
...
function ImageSelection(props: Props) {
  ...
  const _linkList = filter(props.linkList, (link) =>
    includes(link, "http://res.cloudinary.com")
  );
    ...
    <div className="editor-wrapper-image-selection-wrapper">
      {hasNonCloudinaryLinks && (
        <Alert
          ...
          severity="warning"
        >
          For thumbnail, please use (local) image you have already used in your
          article.
        </Alert>
      )}
      {!isEmpty(_linkList) && (
      ...
      <div ref={parentRef} className="editor-wrapper-image-selection">
        {!isEmpty(linkList) &&
          map(linkList, (link, index) => (
            <img
              ...
              onClick={() => {
                ...
                setTimeout(() => {
                  document
                    .getElementById(
                      `editor-wrapper-image-selection-image-${index}`
                    )
                    .scrollIntoView({
                      behavior: "smooth",
                      block: "nearest",
        ...
        {customImageUrl && (
          <img
            ...
            onClick={() => {
              ...
              setTimeout(() => {
                document
                  .getElementById("editor-wrapper-image-selection-image--1")
                  .scrollIntoView({
                    behavior: "smooth",
                    block: "nearest",
                    inline: "center",
        ...
        {!isEmpty(linkList) && (
          <div
            className={classNames(
              ...
              {
                disabled:
                  selectedImageIndex === oldSelectedImageIndex &&
